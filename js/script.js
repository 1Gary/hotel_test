...
$(function () {
	...
	if (plugins.bootstrapDateTimePicker.length) {
		...
		for (i = 0; i < plugins.bootstrapDateTimePicker.length; i++) {
			...
			opciones['formato'] = 'dddd DD MMMM YYYY - HH:mm';
			if ($dateTimePicker.attr("data-time-picker") == "date") {
				opciones['formato'] = 'dddd DD MMMM YYYY';
				opciones['minDate'] = new Date();
			} else if ($dateTimePicker.attr("data-time-picker") == "time") {
				opciones['formato'] = 'HH:mm';
			}

			opciones["tiempo"] = ($dateTimePicker.attr("data-time-picker") != "date");
			opciones["fecha"] = ($dateTimePicker.attr("data-time-picker") != "time");
			opciones["shortTime"] = true;

			// Agregar la opción 'lang' para mostrar el calendario en español
			opciones['lang'] = 'es';

			$dateTimePicker.bootstrapMaterialDatePicker(opciones);
		}
	}
...
var fechaInput = document.getElementById('date-in');
...
// Validar la fecha cuando se selecciona o cambia
fechaInput.addEventListener('input', function () {
	// Obtener la fecha seleccionada por el usuario
	var fechaSeleccionada = fechaInput.value;

	// Si la fecha seleccionada es anterior a hoy, establecer la fecha actual como valor
